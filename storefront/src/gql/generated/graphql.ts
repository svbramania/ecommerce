...
export type ProductDetailQuery = { product: { id: string, name: string, description: unknown, rating: number | null, reviewsMetadata: string | null, bundleComponents: string | null, category: { id: string, name: string, slug: string } | null, thumbnail: { url: string, alt: string | null } | null, media: Array<{ id: string, url: string, alt: string, sortOrder: number | null, type: ProductMediaType }> | null, variants: Array<{ id: string, name: string, quantityAvailable: number | null, pricing: { price: { gross: { amount: number, currency: string } } | null } | null }> | null } | null };
