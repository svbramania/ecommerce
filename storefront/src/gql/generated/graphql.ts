...
export type ProductDetailQuery = { product: { id: string, name: string, description: unknown, seoDescription: string | null, rating: number | null, created: unknown, reviewsMetadata: string | null, bundleComponents: string | null, weight: { value: number, unit: WeightUnitsEnum } | null, category: { id: string, name: string, slug: string } | null, thumbnail: { url: string, alt: string | null } | null, media: Array<{ id: string, url: string, alt: string, sortOrder: number | null, type: ProductMediaType }> | null, assignedAttributes: Array<
...
export type ProductCardFieldsFragment = { id: string, name: string, slug: string, rating: number | null, featured: string | null, salesCount: string | null, thumbnail: { url: string, alt: string | null } | null, pricing: { priceRange: { start: { gross: { amount: number, currency: string } } | null } | null } | null, variants: Array<{ quantityAvailable: number | null }> | null };
...
export type ProductListQuery = { products: { totalCount: number | null, pageInfo: { hasNextPage: boolean, endCursor: string | null }, edges: Array<{ node: { id: string, name: string, slug: string, rating: number | null, featured: string | null, salesCount: string | null, thumbnail: { url: string, alt: string | null } | null, pricing: { priceRange: { start: { gross: { amount: number, currency: string } } | null } | null } | null, variants: Array<{ quantityAvailable: number | null }> | null } }> } | null };
