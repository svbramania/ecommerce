...
export type CurrentUserOrdersQuery = { me: { orders: { edges: Array<{ node: { id: string, number: string, created: unknown, status: OrderStatus, isPaid: boolean, total: { gross: { amount: number, currency: string } } } }> } | null } | null };
...
export type ProductDetailQuery = { product: { id: string, name: string, description: unknown, bundleComponents: string | null, thumbnail: { url: string, alt: string | null } | null, variants: Array<{ id: string, name: string, quantityAvailable: number | null, pricing: { price: { gross: { amount: number, currency: string } } | null } | null }> | null } | null };
