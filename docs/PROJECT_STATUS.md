...
| 3 — Scale (shipping/tax/BNPL/fraud/currency) | **Multi-currency done**, rest not started | A real second channel (EUR), live-verified: same product returns the right price/currency per channel | Shipping rates/tax/BNPL/fraud each need a real third-party account (EasyPost/Shippo, Avalara/TaxJar, Affirm/Klarna, Signifyd/Riskified) — I can't create these myself, that's off-limits regardless of free tiers |
